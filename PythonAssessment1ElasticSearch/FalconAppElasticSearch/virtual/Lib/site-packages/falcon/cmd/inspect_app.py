...
"""
Script that prints out the controller of an App instance.
"""
import argparse
import importlib
import os
...
def make_parser():
    ...
    parser.add_argument(
        ...
        '--route_only',
        action='store_true',
        help='Prints only the information regarding the controller',
    )
    parser.add_argument(
        '-v',
        '--verbose',
...
def route_main():
    print(
        'The "falcon-print-controller" command is deprecated. '
