...
class App:
    ...
    Keyword Arguments:
            ...
            handle; Falcon simply skips over any missing middleware methods::
                ...
                class ExampleComponent:
                    def process_request(self, req, resp):
                        ...
                        Note:
                            Because Falcon controller each request based on
        ...
        sink_before_static_route (bool): Indicates if the sinks should be processed
            before (when ``True``) or after (when ``False``) the static controller.
    ...
    def add_route(self, uri_template, resource, **kwargs):
        ...
        Falcon controller incoming requests to resources based on a set of
        ...
        Keyword Args:
            suffix (str): Optional responder name suffix for this route. If
                ...
                etc. In this way, multiple closely-related controller can be
        ...
        Note:
            ...
            additional options when setting up controller. Custom routers MUST
    ...
    def add_static_route(
        ...
        Static controller provide a way to serve files directly. This
        ...
        Static controller are matched in LIFO order. Therefore, if the same
        prefix is used for two controller, the second one will override the
        first. This also means that more specific controller should be added
        *after* less specific ones. For example, the following sequence
        ...
        Args:
            prefix (str): The path prefix to match for this route. If the
                ...
                Note that static controller are matched in LIFO order, and are only
                attempted after checking dynamic controller and sinks.
    ...
    def add_sink(self, sink, prefix=r'/'):
        ...
        of controller, when creating static resources and responders would be
    ...
    def _get_responder(self, req):
        """Search controller for a matching responder.
