...
class CompiledRouter:
    ...
    number of controller have been added. When adding the last route
    ...
    def add_route(self, uri_template, resource, **kwargs):
        ...
        Keyword Args:
            ...
            compile (bool): Optional flag that can be used to compile the
                ...
                number of controller. Setting `compile` to ``True`` when the last
                ...
                Note:
                    ...
                    addition of new controller when hundreds of them are added at
            ...
            for node in nodes:
                ...
                if node.conflicts_with(segment):
                    raise ValueError(
                        ...
                        'in two different controller, or by using different field names '
