...
def inspect_routes(app: App) -> 'List[RouteInfo]':
    """Inspects the controller of an application.
...
def inspect_static_routes(app: App) -> 'List[StaticRouteInfo]':
    """Inspects the static controller of an application.
    ...
    Returns:
        List[StaticRouteInfo]: A list of static controller that have
...
def inspect_compiled_router(router: CompiledRouter) -> 'List[RouteInfo]':
    """Walk an instance of :class:`~.CompiledRouter` to return a list of defined controller.
...
class AppInfo(_Traversable):
    ...
    Args:
        routes (List[RouteInfo]): The controller of the application.
        middleware (MiddlewareInfo): The middleware information in the application.
        static_routes (List[StaticRouteInfo]): The static controller of this application.
