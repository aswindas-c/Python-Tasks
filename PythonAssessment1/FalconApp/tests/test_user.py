...
def test_post_user_success(client, mocker):
    mock_save = mocker.patch('FalconApp.models.user_model.User.convert_to_dict', return_value=None)
...
def test_create_user_email_already_exists(client,mocker):
    mock_get_collection = mocker.patch('FalconApp.models.mongodb_model.MongoDBModel.get_collection')
...
def test_get_route_user_not_exist(client, mocker):
    mocker.patch('FalconApp.models.user_model.User.find_by_email', return_value=None)
...
def test_get_route_user_exist(client,mocker):
    ...
    mocker.patch('FalconApp.models.user_model.User.find_by_email', return_value=mock_user)
